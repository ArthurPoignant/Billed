            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-employee">
                  ...
                  <input type="email" data-testid="employee-email-input" class="form-control" id="inputEmailEmployee" placeholder="johndoe@email.com" required autofocus>
                  <label for="inputPasswordEmployee">Mot de passe</label>
                  <input type="password" data-testid="employee-password-input" class="form-control" id="inputPasswordEmployee" placeholder="******" required>
            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-admin">
                  ...
                  <input type="email" data-testid="admin-email-input" class="form-control" id="inputEmailAdmin" placeholder="johndoe@email.com" required autofocus>
                  <label for="inputPasswordAdmin">Mot de passe</label>
                  <input type="password" data-testid="admin-password-input" class="form-control" id="inputPasswordAdmin" placeholder="******" required>
